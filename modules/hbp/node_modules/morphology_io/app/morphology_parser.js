...
//       iParent = parent[1]+parent[2]-1
//     }
//     var tp = line[0]
//     for (var i=line[1]; i<line[1]+line[2]; i++) {
//       id += 1
...
//   var swcPoints = this.swcPoints(3)
//   var swcDict = {
//     version: swcPlus_version,
...
//   }
//   if (format == 'jwc') {
//     // jwc format: swc-like JSON
//     return JSON.stringify(swcDict,null,2)
//   } else {
//     var xmlDoc = parser.parseFromString('<swcPlus></swcPlus>',"text/xml");
//     if (format == 'xwc') {
//       // xwc format: swc-like XML
//       xmlLib.fromDict(xmlDoc.documentElement,swcDict,swcPlus_schema['swcPlus'])
//       var xml = (new XMLSerializer()).serializeToString(xmlDoc).replace(/"/g,"'").replace(/&quot;/g,'"')
//       return vkbeautify.xml(xml)
//     } else {
//       // swc format: put XML header in comment section, followed by space-separated points
//       delete swcDict.swcPoints
//       xmlLib.fromDict(xmlDoc.documentElement,swcDict,swcPlus_schema['swcPlus'])
//       var xmlHeader = (new XMLSerializer()).serializeToString(xmlDoc).replace(/"/g,"'").replace(/&quot;/g,'"')
//       var swc = ['# '+vkbeautify.xml(xmlHeader).split('\n').join('\n# ')+'\n#']
//       for (var i=0; i<swcPoints.length; i++) {
//         swc.push( swcPoints[i].join(' ') )
//       }
//       return swc.join('\n')
